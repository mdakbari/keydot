...
$(function () {
    ...
    galleryText.on("transitionStart", function () {
     ...
     var galleryTextModern = new Swiper('.modern-slider .gallery-text .swiper-container', {
        spaceBetween: 30,
        slidesPerView: 1,
        direction: 'vertical',
        loop: true,
    ...
    var galleryImgModern = new Swiper('.modern-slider .gallery-img .swiper-container', {
        spaceBetween: 0,
        slidesPerView: 1,
        effect: 'fade',
        loop: true,
